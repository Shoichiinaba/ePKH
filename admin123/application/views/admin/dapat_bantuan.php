<div class="content-wrapper">
  <section class="content-header">
        <h1>
          Proses
          <small>List Data Dapat Bantuan </small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped" >
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <?php if($g->status_approve==0){
                                                    echo "<span class='label label-warning'> Prosses</span>";
                                                    //$teks="Nonaktifkan Data";
                                                    $icon="switch";
                                                    $class="danger";
                                            }elseif($g->status_approve==1){
                                    ...
                                    <td>
                                     ...
                                     <a href="<?php echo site_url('List_prediksi/delete_dapat/'.$g->no_kk); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');"type="button" class="btn bg-navy btn-xs"  data-placement="top"  title="Hapus"><i class="fa fa-trash-o"></i></a>
                                </tr>
                             ...
                             <div class="row">
                                <div class="col-xs-12">
                                  <div class="box box-success">
                                    ...
                                    <div class="box-body">
                                      <a href="<?php echo base_url()?>index.php/laporan/lapdapat" target="_blank"> 
                                ...
                                <img class="direct-chat-img" src="<?php echo base_url(); ?>assets/img/epkh.png "alt="Message User Image"><!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                      <dl class="dl-horizontal">
                                        ...
                                        <dt style= 'color: navy'>Tanggal ACC :</dt>
                                        <dd style= 'color: navy'> <?php echo $g->tgl_approve; ?></dd>
                                        <dt style= 'color: navy'>Status :</dt>
                                        <dd>
                                            <?php if($g->status_approve==0){
                                                    echo "<span class='label label-warning'> Prosses</span>";
                                                    //$teks="Nonaktifkan Data";
