...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/open-iconic-bootstrap.min.css" type="text/css">
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/scrollax.min.js"></script>
